...
SYSTEM_TEMPLATE = """\
Ты — классификатор запросов для Таро-бота «Прорицательница». Твоя задача: по вопросу \
...
# --------------------------------------------------------------------------- #
VALIDATION_SYSTEM = (
    "Ты — фильтр запросов для Таро-бота «Прорицательница». Реши, есть ли в сообщении "
