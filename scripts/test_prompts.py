...
# -*- coding: utf-8 -*-
"""
scripts/test_prompts.py — тест тона/этики промпта трактовки (Прорицательница).
...
# Разделитель мыслей Прорицательницы и смайлы с лицами (последних быть не должно).
...
def check_reading(text: str, spread_id: str, spread: dict, cards) -> dict:
    ...
    return {
        ...
        # Голос Прорицательницы: дроблёный ответ (≥2 фрагмента), разобрана каждая карта, без
...
# --------------------------------------------------------------------------- #
JUDGE_SYSTEM = (
    "Ты — редактор Таро-бота. Голос бота — Прорицательница: древняя мудрая ведунья у костра, "
...
def main():
    ...
    lines = ["# Тест тона трактовок — Прорицательница", "",
